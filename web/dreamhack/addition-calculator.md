## Addition calculator
This challenge involves crafting an obfucated python payload 
...
Obfucated payload to bypass filter:
```python
...
Submit this to the calculator and get the flag Addition calculator
This challenge involves crafting an obfucated python payload 
